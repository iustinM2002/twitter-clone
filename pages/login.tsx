...
import { SignInProps,FormValues,dataContact } from 'types';
const inputStyle = `w-[50%] border-[1px] border-[#7d7d7d9c] rounded-[0.3rem] px-[0.5rem] py-[1rem] mx-auto my-[1rem] `;
    ...
    <Link href='/'><FontAwesomeIcon  className='cursor-pointer text-black absolute top-[0.5rem] left-[0.5rem] text-[1.2rem] px-[0.7rem] py-[0.45rem] transition-all hover:bg-[#a1a1a16d] rounded-full' icon={faXmark}/></Link>
        ...
        <div className="">
            ...
            <div className="inputs flex flex-col">
                ...
                <input className={inputStyle} type="text" placeholder='Password'  {...register('password',{minLength:4}) }  />
